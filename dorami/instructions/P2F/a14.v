...
Definition a14 : isla_trace :=
  ...
  Smt (DefineConst 5%Z (Unop (SignExtend 32%N) (Manyop (Bvmanyarith Bvadd) [Val (Val_Bits (BV 32%N 0x373%Z)) Mk_annot; Unop (Extract 31%N 0%N) (Val (Val_Symbolic 2%Z) Mk_annot) Mk_annot] Mk_annot) Mk_annot)) Mk_annot :t:
