...
Definition a28 : isla_trace :=
  ...
  Assume (AExp_Binop (Eq) (AExp_Val (AVal_Var "x5" []) Mk_annot) (AExp_Val (AVal_Bits (BV 64%N 0x9b989d989d1e%Z)) Mk_annot) Mk_annot) Mk_annot :t:
  ...
  WriteReg "pmp1cfg" [Field "bits"] (RegVal_Struct [("bits", RegVal_Base (Val_Symbolic 46%Z))]) Mk_annot :t:
  ...
  WriteReg "pmp2cfg" [Field "bits"] (RegVal_Struct [("bits", RegVal_Base (Val_Symbolic 61%Z))]) Mk_annot :t:
  ...
  WriteReg "pmp3cfg" [Field "bits"] (RegVal_Struct [("bits", RegVal_Base (Val_Symbolic 76%Z))]) Mk_annot :t:
  ...
  WriteReg "pmp4cfg" [Field "bits"] (RegVal_Struct [("bits", RegVal_Base (Val_Symbolic 91%Z))]) Mk_annot :t:
  ...
  WriteReg "pmp5cfg" [Field "bits"] (RegVal_Struct [("bits", RegVal_Base (Val_Symbolic 106%Z))]) Mk_annot :t:
  ...
  WriteReg "pmp6cfg" [Field "bits"] (RegVal_Struct [("bits", RegVal_Base (Val_Symbolic 121%Z))]) Mk_annot :t:
  ...
  WriteReg "pmp7cfg" [Field "bits"] (RegVal_Struct [("bits", RegVal_Base (Val_Symbolic 136%Z))]) Mk_annot :t:
  ReadReg "pmp7cfg" [Field "bits"] (RegVal_Struct [("bits", RegVal_Base (Val_Symbolic 136%Z))]) Mk_annot :t:
  ReadReg "pmp6cfg" [Field "bits"] (RegVal_Struct [("bits", RegVal_Base (Val_Symbolic 121%Z))]) Mk_annot :t:
  ReadReg "pmp5cfg" [Field "bits"] (RegVal_Struct [("bits", RegVal_Base (Val_Symbolic 106%Z))]) Mk_annot :t:
  ReadReg "pmp4cfg" [Field "bits"] (RegVal_Struct [("bits", RegVal_Base (Val_Symbolic 91%Z))]) Mk_annot :t:
  ReadReg "pmp3cfg" [Field "bits"] (RegVal_Struct [("bits", RegVal_Base (Val_Symbolic 76%Z))]) Mk_annot :t:
  ReadReg "pmp2cfg" [Field "bits"] (RegVal_Struct [("bits", RegVal_Base (Val_Symbolic 61%Z))]) Mk_annot :t:
  ReadReg "pmp1cfg" [Field "bits"] (RegVal_Struct [("bits", RegVal_Base (Val_Symbolic 46%Z))]) Mk_annot :t:
