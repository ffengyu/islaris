...
Definition a20 : isla_trace :=
  ...
  Smt (DefineConst 12%Z (Binop ((Bvarith Bvshl)) (Val (Val_Symbolic 11%Z) Mk_annot) (Val (Val_Bits (BV 64%N 0xd%Z)) Mk_annot) Mk_annot)) Mk_annot :t:
