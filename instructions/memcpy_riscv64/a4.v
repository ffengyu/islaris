...
Definition a4 : isla_trace :=
  ...
  Smt (DefineConst 13%Z (Unop (ZeroExtend 64%N) (Val (Val_Symbolic 6%Z) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (DefineConst 19%Z (Unop (ZeroExtend 64%N) (Val (Val_Symbolic 6%Z) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (DeclareConst 23%Z (Ty_BitVec 8%N)) Mk_annot :t:
  ReadMem (RegVal_Base (Val_Symbolic 23%Z)) (RegVal_Poison) (RegVal_Base (Val_Symbolic 6%Z)) 1%N None Mk_annot :t:
  Smt (DefineConst 24%Z (Unop (SignExtend 56%N) (Val (Val_Symbolic 23%Z) Mk_annot) Mk_annot)) Mk_annot :t:
  WriteReg "x13" [] (RegVal_Base (Val_Symbolic 24%Z)) Mk_annot :t:
