...
Definition a8 : isla_trace :=
  ...
  Smt (DefineConst 2%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 0%Z) Mk_annot; Val (Val_Bits (BV 64%N 0x40%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
  ...
  WriteReg "x10" [] (RegVal_Base (Val_Symbolic 1%Z)) Mk_annot :t:
